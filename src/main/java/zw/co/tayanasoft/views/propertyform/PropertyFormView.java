package zw.co.tayanasoft.views.propertyform;
...
@Route(value = "property-form", layout = MainLayout.class)
@PermitAll
public class PropertyFormView extends Composite<VerticalLayout> {
