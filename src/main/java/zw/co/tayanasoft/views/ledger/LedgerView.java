package zw.co.tayanasoft.views.ledger;
...
@PermitAll
@Uses(Icon.class)
public class LedgerView extends Div {
    ...
    public LedgerView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("ledger-view");
